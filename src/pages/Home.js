...
import jambtree from '../src/sponsors/jambtree.png'
import cppsecrets from '../src/sponsors/cppsecrets.png'
import interviewcake from '../src/sponsors/interviewcake.png'
import codingblocks from '../src/sponsors/codingblocks.png'
import onepassword from '../src/sponsors/onepassword.png'
import interviewbuddy from '../src/sponsors/interviewbuddy.png'
import givemycertificate from '../src/sponsors/givemycertificate.png'
import elearnmarkets from '../src/sponsors/elearnmarkets.png'
...
function Home() {
  return (
    <div className="home">
      ...
      <Link to={'/login'}><button class="custom-btn btn-16">Begin The Hunt</button></Link>
      </div>
